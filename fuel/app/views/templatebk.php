...
<div id="wrapper" class="active">  
    ...
    <div id="sidebar-wrapper">
        <ul id="sidebar_menu" class="sidebar-nav">
           <li class="sidebar-brand"><a id="menu-toggle" href="#">Assets  <span id="main_icon" class="glyphicon glyphicon-align-justify"></span></a></li>
        </ul>
      ...
      <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
            <div class="row">
              <div class="col-md-12">
              <p class="well lead" align ="center" > HIT Asset Management </p>
            ...
            <?php endif; ?>
              ...
              <p class="well lead"> HIT Asset Management(<a href="#">HIT</a>)</p> 
            </div>
          </div>
        </div>
    </div>
